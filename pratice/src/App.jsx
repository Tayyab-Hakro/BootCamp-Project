...
const BranchEditPage = ({ branchData, onSave }) => {
  ...
  return (
    <div className="bg-white p-6 w-[90%] max-w-lg rounded-xl shadow-xl space-y-4">
      ...
      <div>
        <label className="block mb-2 text-gray-700">Branch Head</label>
        <input
          name="branchHead"
      ...
      <div className="relative">
        <label className="block mb-2 text-gray-700">Operation Days</label>
        <div
...
function App() {
  const [branchData, setBranchData] = useState({
    branchCode: "BR-01",
    branchName: "Bahadurabad Branch",
    branchHead: "Muhammad Hunain",
    status: "Active",
    days: ["Mon", "Tues", "Wed"],
